...
# This script can be used to quickly deploy four psddn instances in a Tmux session.
# Assumes the userProfiles are already created in the database, otherwise it wont work.
